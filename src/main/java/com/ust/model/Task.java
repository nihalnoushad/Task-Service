...
public class Task {
	...
	public Task(Integer id, Integer role_id, String task_name, String task_Descreption, String task_start_date,
	...
	public String toString() {
		return "Task [id=" + id + ", role_id=" + role_id + ", task_name=" + task_name + ", task_Descreption="
